...
export function Footer() {
  return (
    <footer className="border-t border-atlas-blue-100">
      <div className="mx-auto flex max-w-5xl flex-col items-center gap-3 px-6 py-8 text-sm text-slate-500 sm:flex-row sm:justify-between">
        ...
        <div className="flex gap-6">
          <Link href="/contact" className="hover:text-atlas-blue-700">
            Contact
          </Link>
          ...
          <a href="https://os.atlasenrollment.com" className="hover:text-atlas-blue-700">
            Login
          </a>
        </div>
      </div>
